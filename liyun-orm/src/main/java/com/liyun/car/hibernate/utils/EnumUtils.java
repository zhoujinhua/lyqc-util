...
import com.liyun.car.hibernate.type.PersistentEnum;
...
public final class EnumUtils {
		...
		if(metaInfo != null){
			...
			if(ifaces!=null && ifaces.length > 0){
				for(Class iface : ifaces){
					if(iface.equals(com.liyun.car.common.service.Enum.class)){
	...
	private static <T extends java.lang.Enum<T>> T valueForInface(final Class <T> enumType,final Object value,final boolean ignoreType){
		try {
			...
			for(T e : enums){
				if(!ignoreType && ((com.liyun.car.common.service.Enum)e).getValue().equals(value)){
					return e;
				}else if(ignoreType && String.valueOf(((com.liyun.car.common.service.Enum)e).getValue()).equals(String.valueOf(value))){
					return e;
				}
			}
		} catch (Exception e) { 
	...
	public static Object getValue(Enum e){
		...
		if(e instanceof com.liyun.car.common.service.Enum){
			return ((com.liyun.car.common.service.Enum) e).getValue();
		}
